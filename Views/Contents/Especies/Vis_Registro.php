...
<body class="hold-transition sidebar-mini">
  ...
  <div class="content-wrapper">
    <?php $this->Wraper('Catalogo','Especies');?>
    <!-- Main content -->
    <div class="content">
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="form-group col-md-8">
                      ...
                      <input type="text" pattern="[A-Za-z ]{3,30}" name="Esp" id="Des" class="form-control" placeholder="Descripcion" minlength="3" maxlength="30" style="text-transform: uppercase;" required>
                    </div>
                  </div>
                  ...
                  <div class="row card-footer">
                    <div class="col-md-12 text-center">
                      <div class="btn-group ">
                        ...
                        <button type="button" class="btn btn-primary" onclick="Paginador('EspeciesController',1)" data-toggle="modal" data-target="#ModalListar"> 
