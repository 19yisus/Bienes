...
<body class="hold-transition sidebar-mini">
  ...
  <div class="content-wrapper">
    <?php $this->Wraper('Catalogo','Personas','Registro de peronas');?>
    <!-- Main content -->
    <div class="content">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-md-5">
                      ...
                      <select name="Dep" id="Dep" class="form-control js-example-responsive" style="width: 100%; height: calc(2.25rem + 2px) !important;" required>
