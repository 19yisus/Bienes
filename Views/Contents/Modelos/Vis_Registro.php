...
<body class="hold-transition sidebar-mini">
  ...
  <div class="content-wrapper">
    <?php $this->Wraper('Catalogo','Modelos');?>
    <!-- Main content -->
    <div class="content">
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <select name="Marca" id="Marca" class="custom-select" required>
                  ...
                  <div class="row card-footer">
                    <div class="col-md-12 text-center">
                      <div class="btn-group ">
                        ...
                        <button type="button" class="btn btn-primary" onclick="Paginador('ModelosController',1)" data-toggle="modal" data-target="#ModalListar"> 
