...
<body class="hold-transition sidebar-mini">
  ...
  <div class="content-wrapper">
    <?php $this->Wraper('Catalogo','Clasificacion');?>
    <!-- Main content -->
    <div class="content">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="form-group col-md-3">
                      ...
                      <input type="text" name="Cod" id="Cod" pattern="[0-9]{2}" class="form-control" placeholder="Codigo" maxlength="2" minlength="2" required>
                    </div>
                  ...
                  <div class="row card-footer">
                    <div class="col-md-12 text-center">
                      <div class="btn-group ">
                        ...
                        <button type="button" class="btn btn-primary" onclick="Paginador('ClasificacionController',1)" data-toggle="modal" data-target="#ModalListar"> 
